...
namespace AccountMicroservice.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
                ...
                if (data1 == "Success")
                {
                    if(value.AccountId%2==0)
                    {
                        ...
                        if (sa != null)
                        {
                            ...
                            return new Depositwithdraw { AccountID = value.AccountId, Message = "Deposit Failed due to Link Failure", Balance = value.Balance };
                    }
        ...
        public ActionResult<Depositwithdraw> Withdraw([FromBody] dwacc value)
        {
                ...
                if (data1 == "No Warning")
                {
                    if (value.AccountId % 2 == 0)
                    {
                        ...
                        if (sa != null)
                        {
                            ...
                            new Depositwithdraw { AccountID = value.AccountId, Message = "Withdraw Failed due to Link Failure", Balance = value.Balance };
            ...
            return new Depositwithdraw { AccountID = value.AccountId, Message = "Withdraw Failed due to Link Failure", Balance = value.Balance };
            //return "Link Failure";
        }
        ...
        //    var currentAccounts = ob.GetCurrentAccountsList();
          //  var savingsAccounts = ob.GetSavingsAccountsList();
            ...
            if (value.source_accid % 2 == 0)
            {
                ...
                if (sas==null)
                    return new transactionmsg { sbal = sb, rbal = db, transferStatus = "Transaction Failed due to Link Failure." };
            }
            else
            {
